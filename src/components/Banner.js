...
const Banner = (props) => {
    ...
    return (
        ...
        justify-content-center bannerContainer tema light">
            <div>     
                <h1>
                    <svg width="9em" height="10em" viewBox="0 0 16 16" class="bi bi-flag-fill" fill="rgba(255, 255, 255, 0.20)" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="p-2 align-items-center text-center 
