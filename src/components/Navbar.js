                        ...
                        <div className="container d-flex justify-content-end">
                            <div className="dropleft">  
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a href="" className="dropdown-item" onClick = {() => alert("action clicked")}>Action</a></li>
                                    <li><a href="" className="dropdown-item" onClick = {() => alert("light clicked")}>Light</a></li>
                                    <li><a href="" className="dropdown-item" onClick = {() => alert("dark clicked")}>Dark</a></li>
                                </ul>
                            </div>      
                        </div>                                              
                    </div>     
